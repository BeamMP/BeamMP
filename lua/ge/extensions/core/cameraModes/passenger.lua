...
-- This code is a manipulated form of the games installation ./lua/ge/extensions/core/cameraModes/driver.lua to create a passenger camera.
...
function C:update(data)
  ...
  if not data.veh.mpVehicleType or data.veh.mpVehicleType == 'L' then
    core_camera.setVehicleCameraByIndexOffset(0, 1) extensions.hook('onBeamMPTrackCameraMode')
    return
  end
  ...
  if not camNodeID then core_camera.setVehicleCameraByIndexOffset(0, 1) extensions.hook('onBeamMPTrackCameraMode') return end
