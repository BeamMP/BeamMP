...
M.defaultSettings = {
    colors = {
        ...
        buttonHovered = imgui.ImVec4(1.0, 0.679, 0.472, 1),
        buttonActive = imgui.ImVec4(1.0, 0.679, 0.472, 1),
        textColor = imgui.ImVec4(1, 1, 1, 1),
        primaryColor = imgui.ImVec4(0.13, 0.13, 0.13, 1),
        secondaryColor = imgui.ImVec4(1.0, 0.392, 0.0, 1)
    },
    window = {
        inactiveFade = true,
        fadeTime = 1,
...
-- split function to split strings by the designated seperator.
